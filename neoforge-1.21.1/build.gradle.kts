...
val neoforgeVersion: String = providers.gradleProperty("neoforge_version_1_21_1").get()
val parchmentMc: String = providers.gradleProperty("parchment_mc_1_21_1").get()
val parchmentVer: String = providers.gradleProperty("parchment_version_1_21_1").get()
...
tasks.processResources {
    val replacements = mapOf(
        ...
        "mc_version_range" to "[1.21.1,1.21.2)",
        "neoforge_version_range" to "[21.1,21.2)",
